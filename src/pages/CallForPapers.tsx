      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 gradient-hero bg-clip-text text-transparent">
            Call for Papers
            <a href="https://scientificnet-my.sharepoint.com/:p:/g/personal/errauch_unibz_it/EUfjUsKcdNRLoJkVB-SH0ekB4p2TQS7OjEwPHpw0tjb-Yw?rtime=HPFvDHgK3kg" target="_blank" rel="noopener noreferrer" className="ml-4 text-sm font-normal underline"><h1>Submit Abstracts and Papers in Conftool here.</h1> </a>
          </h1>
