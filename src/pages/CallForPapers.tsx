...
const CallForPapers = () => {
  ...
  const dates = [
    { event: "Abstract Deadline Extended to March 21", date: "March 21, 2026" },
    { event: "Notification of Acceptance", date: "March 28, 2026" },
    { event: "Paper Submission Deadline", date: "March 21, 2026" },
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 gradient-hero bg-clip-text text-transparent">
            Call for Papers Extended till March 21, 2026
          </h1>
          <a href="https://www.conftool.com/icad2026/" target="_blank" rel="noopener noreferrer" className="text-2xl underline text-primary hover:text-primary/80 mb-6 inline-block">
            Submit Abstracts and Papers in Conftool here. Expected length of full papers 8-12 pages in Springer Format.
          </a>
